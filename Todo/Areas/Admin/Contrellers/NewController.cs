...
namespace Todo.Areas.Admin.Contrellers
{
    ...
    public class NewController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var todos = await _context.todos.Where(t => t.ApplicationUserId == currentUserId && t.IDeleted == false && t.IChecked == false && t.ProjectId == null && t.DateOfCreation == DateTime.Today).Include(t => t.Priority).ToListAsync();
